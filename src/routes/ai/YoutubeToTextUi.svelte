...
<div class="form-container">
    ...
    <div class="lg:tooltip w-4/5" data-tip="Article Recommender">
        <button class="btn">Translates Youttube-Videos to text!</button>
    </div>
    <br>
    <div class="w-4/5">
        ...
        <!--        };-->
        <!--      }}>-->
        <form action="http://127.0.0.1:8000/pinecone/youtubetotext" method="post"
              class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"
              use:enhance={({ form, data, action, cancel, submitter }) => {
        ...
        return async ({ result, update }) => {
          ...
          loading = false;
            ...
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="urls" type="text" name="urls" placeholder="Type your urls (url1,url2, etc.) here">
            </div>
