...
<div class="form-container">
        ...
        return async ({ result, update }) => {
          ...
          loading = false;
            ...
            <div class="mb-6">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="section" type="text" name="section" placeholder="Type searched section (e.g Sports) here">
            </div>
    ...
    {#if articles !== undefined && !loading}

        <article>
            <h2>List of recommended articles</h2>
            {#each articles as article}
                ...
                <div class="border-b border-gray-200 dark:border-dim-200 hover:bg-gray-100 dark:hover:bg-dim-300 cursor-pointer transition duration-350 ease-in-out pb-4 border-l border-r">
                    <div class="flex flex-shrink-0 pt-4 pb-0 text-gray-400">
                        ...
                        <div class="text-xs font-bold">{article.section}</div>
                    </div>
                    <div class="flex flex-shrink-0 px-4">
                        <a href="/ai" class="flex-shrink-0 group block">
                            <div class="flex items-top">
                                <div>
                                    <img class="inline-block h-9 w-9 rounded-full" src="https://pbs.twimg.com/profile_images/1325420616258887686/ghhYYwwT_normal.jpg" alt="">
                                </div>
                                <div class="ml-3">
                                    <p class="flex items-center text-base leading-6 font-medium text-gray-800 dark:text-white">
                                        {article.title}
                                        <svg viewBox="0 0 24 24" aria-label="Verified account" fill="currentColor" class="w-4 h-4 ml-1 text-blue-500 dark:text-white">
                                            <g>
                    ...
                    <div class="pl-16">
                        <p class="text-base width-auto font-medium text-gray-800 dark:text-white flex-shrink mb-6">
                            {article.content}
                        </p>
                        ...
                        <div class="flex">
                            <div class="w-full">
                                <div class="flex items-center">
                                    <div class="flex-1 flex items-center dark:text-white text-xs text-gray-400 hover:text-blue-400 dark:hover:text-blue-400 transition duration-350 ease-in-out">
                                    ...
                                    <div class="flex-1 flex items-center dark:text-white text-xs text-gray-400 hover:text-green-400 dark:hover:text-green-400 transition duration-350 ease-in-out">
                                        <svg viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 mr-2">
                                            <g>
